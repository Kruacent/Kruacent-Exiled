...
namespace KruacentExiled.Map.Utils
{
    public static class StructureSpawner
    {
        ...
        public static Locker LockerPrefab(LockerType lockertype)
        {
        ...
        public static Locker SpawnPedestal(ItemType item, Vector3 position, Quaternion rotation,Vector3? scale)
        {
            Locker locker = UnityEngine.Object.Instantiate(LockerPrefab(LockerType.PedestalScp500));
            Vector3 absolutePosition = position;
            Quaternion absoluteRotation = rotation;
