...
namespace KruacentExiled.Map.Surface.ElevatorGateA
{
    public class ElevatorModel : ModelBase, IContainPanel
    {
        ...
        protected override void CreateModel(Transform parent)
        {
            ...
            ElevatorCabin.PrimitiveFlags = PrimitiveFlags.None;
            ...
            top.PrimitiveFlags = PrimitiveFlags.None;
            ...
            Spot_Light.PrimitiveFlags = PrimitiveFlags.None;
            ...
            bottom.PrimitiveFlags = PrimitiveFlags.None;
            ...
            fence.PrimitiveFlags = PrimitiveFlags.None;
