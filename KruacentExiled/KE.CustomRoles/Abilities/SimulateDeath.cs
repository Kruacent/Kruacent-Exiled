...
namespace KE.CustomRoles.Abilities
{
    public class SimulateDeath : KEAbilities
    {
        ...
        protected override void AbilityUsed(Player player)
        {
            ...
            Ragdoll ragdoll = Ragdoll.CreateAndSpawn(player.Role, player.DisplayNickname, deathTranslation.GetRandomValue().ToString(), player.Position, player.ReferenceHub.PlayerCameraReference.rotation, player);
