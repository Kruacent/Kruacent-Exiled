...
namespace KruacentExiled.CustomRoles.API.Features
{
    ...
    public abstract class KEAbilities
    {
        ...
        private static Dictionary<Type, KEAbilities> TypeToAbility { get; } = new Dictionary<Type, KEAbilities>();
        ...
        {
            return playerWithActiveAbility.Contains(player);
        }
        ...
        public bool CanUse(Player player, out string result)
        {
            ...
            if (blockedPlayer.Contains(player))
            {
                result = "blocked";
                return false;
            }
