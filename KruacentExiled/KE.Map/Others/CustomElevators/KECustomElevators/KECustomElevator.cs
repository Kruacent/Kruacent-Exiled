...
namespace KE.Map.Others.CustomElevators.KECustomElevators
{
    public class KECustomElevator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            BottomHeight = base.transform.localPosition.y;
        ...
        {
            model.Create(base.transform);
            toppanel.Create(base.transform);
            bottompanel.Create(base.transform);
